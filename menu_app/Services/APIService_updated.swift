...
//    }
//    
//    func toggleFavorite(dishId: Int) async throws {
//        let url = URL(string: "\(baseURL)/mark")!
...
//                }
//            }
//            Self.logger.info("Dish favorite toggled successfully")
//        } catch {
//            Self.logger.error("Error toggling favorite: \(error.localizedDescription)")
//            throw error
//        }
//    }
//    
...
//        // Удаляем все блюда (это удаляет и шеф-повара, судя по требованию)
